...
ActiveRecord::Schema.define(version: 2021_01_21_101926) do
  ...
  create_table "ordered_products", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["email"], name: "index_ordered_products_on_email", unique: true
    t.index ["reset_password_token"], name: "index_ordered_products_on_reset_password_token", unique: true
  end
